...
/**
 * Component props.
 * @property {number} currentStep - The index of the currently active step in the indicator.
 */
...
/**
 * Array of route names corresponding to each emergency step.
 * @type {string[]}
 */
const steps = [
  'seek-safety',     
...
/**
 * Navigates to the selected step based on the index.
